...
public class EsCRUD {
    ...
    public void init() throws Exception {
        ...
        client = new PreBuiltTransportClient(settings).addTransportAddresses(
                new InetSocketTransportAddress(InetAddress.getByName("192.168.52.206"), 9300),
                new InetSocketTransportAddress(InetAddress.getByName("192.168.52.207"), 9300),
                new InetSocketTransportAddress(InetAddress.getByName("192.168.52.208"), 9300));
